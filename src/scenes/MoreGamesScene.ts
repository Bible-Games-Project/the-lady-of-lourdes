...
export class MoreGamesScene extends Phaser.Scene {
  ...
  create(): void {
    ...
    createText(this, GAME_WIDTH / 2, 90, Localization.t(K.MORE_GAMES_TITLE), { fontSize: '20px', color: '#fffaf0' }).setOrigin(0.5);

    createText(this, GAME_WIDTH / 2, 130, Localization.t(K.MORE_GAMES_COMING_SOON), {
      fontSize: '13px',
      color: '#c9beac',
      align: 'center',
